...
struct TimerConfigurationView: View {
    ...
    private func applyTabataPreset() {
        ...
        intervals = [
            ...
            TimerInterval(name: "Exercise 1", duration: 20, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 10, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Exercise 2", duration: 20, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 10, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Exercise 3", duration: 20, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 10, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Exercise 4", duration: 20, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 10, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Final Sprint", duration: 20, type: .work, color: "#4285F4"),
            TimerInterval(name: "Cool Down", duration: 30, type: .rest, color: "#34A853")
        ]
    }
    ...
    private func apply5x5Preset() {
        ...
        intervals = [
            TimerInterval(name: "Prepare", duration: 30, type: .preparation, color: "#8E44AD"),
            TimerInterval(name: "Set 1", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 90, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Set 2", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 90, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Set 3", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 90, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Set 4", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 90, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Set 5", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Cool Down", duration: 180, type: .rest, color: "#34A853")
        ]
    }
    ...
    private func applyCircuitPreset() {
        ...
        intervals = [
            TimerInterval(name: "Prepare", duration: 30, type: .preparation, color: "#8E44AD"),
            TimerInterval(name: "Round 1", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 60, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Round 2", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Rest", duration: 60, type: .rest, color: "#EA4335"),
            TimerInterval(name: "Round 3", duration: 180, type: .work, color: "#4285F4"),
            TimerInterval(name: "Cool Down", duration: 120, type: .rest, color: "#34A853")
        ]
    }
}
